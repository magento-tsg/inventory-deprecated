...
use Magento\InventoryConfigurableProduct\Model\ProductQtyRemainingChecker;
...
class GetQty
{
    ...
    /**
     * @var ProductQtyRemainingChecker
     */
     ...
     * @param ProductQtyRemainingChecker $productQtyLeftChecker
    ...
    public function __construct(
        ...
        ProductQtyRemainingChecker $productQtyLeftChecker,
    ...
    public function aroundExecute(Subject $subject)
    {
        ...
        try {
            if ($productId) {
                ...
                $response['qty'] = $this->productQtyLeftChecker->getProductQtyRemainingBySku($optionSku, $stockId);
            }
